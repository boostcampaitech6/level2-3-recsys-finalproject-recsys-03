...
def parse_args():
    ...
    parser.add_argument('--user_filename', default='user.csv', type=str, help='user 파일명 (csv 형식)')
    parser.add_argument('--track_filename', default='track_with_interaction.csv', type=str, help='track 파일명 (csv 형식)')
    ...
    parser.add_argument('--model_name', default='cf_model', type=str, help='모델명')
    ...
    parser.add_argument('--batch_size', default=2048, type=int, help='DataLoader batch size')
    ...
    parser.add_argument('--graph_filename', default='graph_data_cf_model.pt', type=str, help='그래프 데이터 파일명')
    parser.add_argument('--model_filename', default='cf_model.pt', type=str, help='모델 파일명')
